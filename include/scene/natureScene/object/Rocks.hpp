...
public:
  Rocks() : Object()
  {
    std::vector<glm::vec3> rockPositions = {
      ...
      {-136.9970f,  -7.82731f,   90.3449f },
      {-133.2180f, -11.97640f,   13.8824f},
      {-131.0660f,  -9.51755,    4.4811f},
    ...
    for (const auto& pos : rockPositions) {
      ...
      rock->transform.setScale(glm::vec3(scale, scale, scale));
