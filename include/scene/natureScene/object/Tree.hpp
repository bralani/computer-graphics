...
public:
  Tree() : Object()
  {
    std::vector<glm::vec3> treePositions = {
      ...
      { -75.2893f,  -5.06523f,   157.4670f },
      { -84.3420f,  -6.98780f,   154.6460f },
      { -89.3862f,  -6.98780f,   153.0730f },
      { -95.1923f,  -7.71502f,   151.2640f },
